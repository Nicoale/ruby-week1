require './lib/account'
    describe Account do
        ...
        it 'returns message on withdrawal' do
            ...
            pin = subject.pin
            subject.deposit(1000)
            expect(subject.withdraw(agent_number, 200, 1234 )).to eq "Confirmed you withdrew 200, your new balance 800
        ...
        it 'returns error if current balance less than withdrawn amount' do
            agent_number = Account.agent_numbers.firstpin = subject.pin
            balance = subject.balance
